...
public class ReportService {
  ...
  private void generatePaymentReport(
    ...
    recursion(
        (startId) ->
            paymentRepository.findAllByCreatedAtBetweenAndIdGreaterThanEqualOrderByIdAsc(
                range.lowerEndpoint(), range.upperEndpoint(), startId, 1000),
  ...
  private void generateCheckInReport(
    ...
    recursion(
        (startId) ->
            orderRepository.findAllByCheckInTimeBetweenAndIdGreaterThanEqualOrderByIdAsc(
                range.lowerEndpoint(), range.upperEndpoint(), startId, 1000),
  ...
  private void generateBookedReport(
    ...
    recursion(
        (startId) ->
            bookingRepository.findAllByCheckInDateBetweenAndIdGreaterThanEqualOrderByIdAsc(
                range.lowerEndpoint(), range.upperEndpoint(), startId, 1000),
